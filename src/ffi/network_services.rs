...
unsafe extern "C" {
    ...
    pub(crate) fn sc_network_service_copy_protocol(raw: Handle, protocol_type: *const c_char) -> Handle;
    pub(crate) fn sc_network_service_add_protocol_type(raw: Handle, protocol_type: *const c_char) -> u8;
    ...
    pub(crate) fn sc_network_service_remove_protocol_type(raw: Handle, protocol_type: *const c_char) -> u8;
