...
#[test]
fn reachability_supports_name_address_and_callback_operations() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let mut by_address = Reachability::with_address(SocketAddr::V4(SocketAddrV4::new(
        Ipv4Addr::LOCALHOST,
        0,
    )))?;
